package com.example.SmartPark.ui.theme.screens.Upark
...
@Composable
fun UparkScreen(navController: NavController){
    Column(modifier = Modifier
        .fillMaxSize()
        .background(Purple2), ) {
        val mContext = LocalContext.current
        //TopAppBar
        TopAppBar(title ={Text(text = "Uhuru Park", color = Purple2)} ,
...
@Composable
fun uparkscreenpreview(){
    UparkScreen(rememberNavController())
}